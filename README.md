...
Также, в процессе реализации анимаций, были закреплены навыки работы с асинхронностью в React.
...
Посмотреть web-страницу на gitHub Pages: http://localhost:3000/algovisual
